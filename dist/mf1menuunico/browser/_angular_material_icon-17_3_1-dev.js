...
import { SecurityContext, Injectable, Optional, Inject, SkipSelf, ErrorHandler as ErrorHandler2, InjectionToken, inject, booleanAttribute, Component, ViewEncapsulation, ChangeDetectionStrategy, Attribute, Input, NgModule } from "@angular/core";
...
var MatIconRegistry = class _MatIconRegistry {
  ...
  static {
    this.ɵfac = function MatIconRegistry_Factory(t) {
      return new (t || _MatIconRegistry)(i0.ɵɵinject(i1.HttpClient, 8), i0.ɵɵinject(i2.DomSanitizer), i0.ɵɵinject(DOCUMENT, 8), i0.ɵɵinject(i0.ErrorHandler));
    };
  }
  static {
...
var MatIcon = class _MatIcon {
  ...
  static {
    this.ɵfac = function MatIcon_Factory(t) {
      return new (t || _MatIcon)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(MatIconRegistry), i0.ɵɵinjectAttribute("aria-hidden"), i0.ɵɵdirectiveInject(MAT_ICON_LOCATION), i0.ɵɵdirectiveInject(i0.ErrorHandler), i0.ɵɵdirectiveInject(MAT_ICON_DEFAULT_OPTIONS, 8));
    };
  }
  static {
