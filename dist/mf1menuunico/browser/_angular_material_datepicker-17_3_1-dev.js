...
import { Overlay as Overlay2, FlexibleConnectedPositionStrategy, OverlayConfig, OverlayModule } from "@angular/cdk/overlay";
...
import { DateAdapter as DateAdapter2, MAT_DATE_FORMATS, _ErrorStateTracker, MatCommonModule } from "@angular/material/core";
import { Subject, Subscription, merge, of } from "rxjs";
import { ESCAPE, hasModifierKey, SPACE, ENTER, PAGE_DOWN, PAGE_UP, END, HOME, DOWN_ARROW, UP_ARROW, RIGHT_ARROW, LEFT_ARROW, BACKSPACE } from "@angular/cdk/keycodes";
import * as i2 from "@angular/cdk/bidi";
import { Directionality as Directionality2 } from "@angular/cdk/bidi";
...
function MatMonthView_For_4_Template(rf, ctx) {
  if (rf & 1) {
    i0.ɵɵelementStart(0, "th", 2)(1, "span", 5);
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
...
var MatCalendarBody = class _MatCalendarBody {
  ...
  static {
    this.ɵfac = function MatCalendarBody_Factory(t) {
      return new (t || _MatCalendarBody)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.NgZone));
    };
  }
  static {
...
var MatSingleDateSelectionModel = class _MatSingleDateSelectionModel extends MatDateSelectionModel {
  ...
  static {
    this.ɵfac = function MatSingleDateSelectionModel_Factory(t) {
      return new (t || _MatSingleDateSelectionModel)(i0.ɵɵinject(i1.DateAdapter));
    };
  }
  static {
    this.ɵprov = /* @__PURE__ */i0.ɵɵdefineInjectable({
...
var MatRangeDateSelectionModel = class _MatRangeDateSelectionModel extends MatDateSelectionModel {
  ...
  static {
    this.ɵfac = function MatRangeDateSelectionModel_Factory(t) {
      return new (t || _MatRangeDateSelectionModel)(i0.ɵɵinject(i1.DateAdapter));
    };
  }
  static {
    this.ɵprov = /* @__PURE__ */i0.ɵɵdefineInjectable({
...
var MAT_SINGLE_DATE_SELECTION_MODEL_PROVIDER = {
  ...
  deps: [[new Optional(), new SkipSelf(), MatDateSelectionModel], DateAdapter2],
...
var DefaultMatCalendarRangeStrategy = class _DefaultMatCalendarRangeStrategy {
  ...
  static {
    this.ɵfac = function DefaultMatCalendarRangeStrategy_Factory(t) {
      return new (t || _DefaultMatCalendarRangeStrategy)(i0.ɵɵinject(i1.DateAdapter));
    };
  }
  static {
    this.ɵprov = /* @__PURE__ */i0.ɵɵdefineInjectable({
...
var MAT_CALENDAR_RANGE_STRATEGY_PROVIDER = {
  ...
  deps: [[new Optional(), new SkipSelf(), MAT_DATE_RANGE_SELECTION_STRATEGY], DateAdapter2],
...
var MatMonthView = class _MatMonthView {
  ...
  static {
    this.ɵfac = function MatMonthView_Factory(t) {
      return new (t || _MatMonthView)(i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(i2.Directionality, 8), i0.ɵɵdirectiveInject(MAT_DATE_RANGE_SELECTION_STRATEGY, 8));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
...
var MatMultiYearView = class _MatMultiYearView {
  ...
  static {
    this.ɵfac = function MatMultiYearView_Factory(t) {
      return new (t || _MatMultiYearView)(i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(i2.Directionality, 8));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
...
var MatYearView = class _MatYearView {
  ...
  static {
    this.ɵfac = function MatYearView_Factory(t) {
      return new (t || _MatYearView)(i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(i2.Directionality, 8));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
...
var MatCalendarHeader = class _MatCalendarHeader {
  ...
  static {
    this.ɵfac = function MatCalendarHeader_Factory(t) {
      return new (t || _MatCalendarHeader)(i0.ɵɵdirectiveInject(MatDatepickerIntl), i0.ɵɵdirectiveInject(forwardRef(() => MatCalendar)), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
...
var MatCalendar = class _MatCalendar {
  ...
  static {
    this.ɵfac = function MatCalendar_Factory(t) {
      return new (t || _MatCalendar)(i0.ɵɵdirectiveInject(MatDatepickerIntl), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
...
var MatDatepickerContent = class _MatDatepickerContent {
  ...
  static {
    this.ɵfac = function MatDatepickerContent_Factory(t) {
      return new (t || _MatDatepickerContent)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(MatDateSelectionModel), i0.ɵɵdirectiveInject(i1.DateAdapter), i0.ɵɵdirectiveInject(MAT_DATE_RANGE_SELECTION_STRATEGY, 8), i0.ɵɵdirectiveInject(MatDatepickerIntl));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
      ...
      template: function MatDatepickerContent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          i0.ɵɵattribute("aria-modal", true)("aria-labelledby", (tmp_3_0 = ctx._dialogLabelId) !== null && tmp_3_0 !== void 0 ? tmp_3_0 : void 0);
          i0.ɵɵadvance();
  ...
  static {
    this.ɵfac = /* @__PURE__ */(() => {
      ...
      return function MatDatepicker_Factory(t) {
        return (ɵMatDatepicker_BaseFactory || (ɵMatDatepicker_BaseFactory = i0.ɵɵgetInheritedFactory(_MatDatepicker)))(t || _MatDatepicker);
      };
    })();
  }
  static {
...
var MatDatepickerInputBase = class _MatDatepickerInputBase {
  ...
  static {
    this.ɵfac = function MatDatepickerInputBase_Factory(t) {
      return new (t || _MatDatepickerInputBase)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(MAT_DATE_FORMATS, 8));
    };
  }
  static {
    this.ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
...
var MatDatepickerInput = class _MatDatepickerInput extends MatDatepickerInputBase {
  ...
  static {
    this.ɵfac = function MatDatepickerInput_Factory(t) {
      return new (t || _MatDatepickerInput)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), i0.ɵɵdirectiveInject(MAT_FORM_FIELD, 8));
    };
  }
  static {
    this.ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
...
var MatDatepickerToggle = class _MatDatepickerToggle {
  ...
  static {
    this.ɵfac = function MatDatepickerToggle_Factory(t) {
      return new (t || _MatDatepickerToggle)(i0.ɵɵdirectiveInject(MatDatepickerIntl), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵinjectAttribute("tabindex"));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
...
var MatDateRangeInputPartBase = class _MatDateRangeInputPartBase extends MatDatepickerInputBase {
  ...
  constructor(_rangeInput, _elementRef, _defaultErrorStateMatcher, _injector, _parentForm, _parentFormGroup, dateAdapter, dateFormats) {
    ...
    this._dir = inject(Directionality2, {
      optional: true
    });
...
var MatStartDate = class _MatStartDate extends MatDateRangeInputPartBase {
  ...
  static {
    this.ɵfac = function MatStartDate_Factory(t) {
      return new (t || _MatStartDate)(i0.ɵɵdirectiveInject(MAT_DATE_RANGE_INPUT_PARENT), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i1.ErrorStateMatcher), i0.ɵɵdirectiveInject(i0.Injector), i0.ɵɵdirectiveInject(i2$1.NgForm, 8), i0.ɵɵdirectiveInject(i2$1.FormGroupDirective, 8), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(MAT_DATE_FORMATS, 8));
    };
  }
  static {
    this.ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
...
var MatEndDate = class _MatEndDate extends MatDateRangeInputPartBase {
  ...
  static {
    this.ɵfac = function MatEndDate_Factory(t) {
      return new (t || _MatEndDate)(i0.ɵɵdirectiveInject(MAT_DATE_RANGE_INPUT_PARENT), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i1.ErrorStateMatcher), i0.ɵɵdirectiveInject(i0.Injector), i0.ɵɵdirectiveInject(i2$1.NgForm, 8), i0.ɵɵdirectiveInject(i2$1.FormGroupDirective, 8), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(MAT_DATE_FORMATS, 8));
    };
  }
  static {
    this.ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
...
var MatDateRangeInput = class _MatDateRangeInput {
  ...
  static {
    this.ɵfac = function MatDateRangeInput_Factory(t) {
      return new (t || _MatDateRangeInput)(i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i2$1.ControlContainer, 10), i0.ɵɵdirectiveInject(i1.DateAdapter, 8), i0.ɵɵdirectiveInject(MAT_FORM_FIELD, 8));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
  ...
  static {
    this.ɵfac = /* @__PURE__ */(() => {
      ...
      return function MatDateRangePicker_Factory(t) {
        return (ɵMatDateRangePicker_BaseFactory || (ɵMatDateRangePicker_BaseFactory = i0.ɵɵgetInheritedFactory(_MatDateRangePicker)))(t || _MatDateRangePicker);
      };
    })();
  }
  static {
...
var MatDatepickerApply = class _MatDatepickerApply {
  ...
  static {
    this.ɵfac = function MatDatepickerApply_Factory(t) {
      return new (t || _MatDatepickerApply)(i0.ɵɵdirectiveInject(MatDatepickerBase));
    };
  }
  static {
    this.ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
...
var MatDatepickerCancel = class _MatDatepickerCancel {
  ...
  static {
    this.ɵfac = function MatDatepickerCancel_Factory(t) {
      return new (t || _MatDatepickerCancel)(i0.ɵɵdirectiveInject(MatDatepickerBase));
    };
  }
  static {
    this.ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
...
var MatDatepickerActions = class _MatDatepickerActions {
  ...
  static {
    this.ɵfac = function MatDatepickerActions_Factory(t) {
      return new (t || _MatDatepickerActions)(i0.ɵɵdirectiveInject(MatDatepickerBase), i0.ɵɵdirectiveInject(i0.ViewContainerRef));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
