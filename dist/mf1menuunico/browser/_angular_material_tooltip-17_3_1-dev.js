...
import { InjectionToken, inject, ElementRef as ElementRef2, Directive, Inject, Optional, Input, ANIMATION_MODULE_TYPE, Component, ViewEncapsulation, ChangeDetectionStrategy, ViewChild, NgModule } from "@angular/core";
...
var MatTooltip = class _MatTooltip {
  ...
  _createOverlay(origin) {
    if (this._overlayRef) {
      ...
      if ((!this.positionAtOrigin || !origin) && existingStrategy._origin instanceof ElementRef2) {
...
var TooltipComponent = class _TooltipComponent {
  ...
  static {
    this.ɵfac = function TooltipComponent_Factory(t) {
      return new (t || _TooltipComponent)(i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8));
    };
  }
  static {
