...
import { forwardRef, InjectionToken, EventEmitter, booleanAttribute, Directive, Output, ContentChildren, Input, numberAttribute, ANIMATION_MODULE_TYPE, ElementRef as ElementRef2, Component, ViewEncapsulation, ChangeDetectionStrategy, Optional, Inject, Attribute, ViewChild, NgModule } from "@angular/core";
...
var MatRadioGroup = class _MatRadioGroup {
  ...
  static {
    this.ɵfac = function MatRadioGroup_Factory(t) {
      return new (t || _MatRadioGroup)(i0.ɵɵdirectiveInject(i0.ChangeDetectorRef));
    };
  }
  static {
    ...
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
      ...
      viewQuery: function MatRadioButton_Query(rf, ctx) {
        if (rf & 1) {
          ...
          i0.ɵɵviewQuery(_c1, 7, ElementRef2);
        }
        if (rf & 2) {
          let _t;
